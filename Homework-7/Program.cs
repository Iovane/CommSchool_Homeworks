...
class Program
{
    ...
    static int getSum(int hoursWorked)
    {
        var salaryInWeek = 0;

        if (hoursWorked > 8) salaryInWeek += 10 + (hoursWorked - 8) * 5;
        else salaryInWeek += hoursWorked * 10;
